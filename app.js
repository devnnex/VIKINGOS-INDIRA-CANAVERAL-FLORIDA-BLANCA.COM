...
// ---------- Config ----------
const BUSINESS_PHONE = '573204761403'; // <- reemplaza por el número real (sin '+')
const DELIVERY_FEE = 0; // tarifa por defecto de domicilio
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxVPk8ff7LhtyyOxpNjx2KOdtJj5V2SMc1OP9LL8wF74vDWQsRgU9hi5S2c2thLfDeA/exec';
const AVAILABILITY_POLL_MS = 500;

// ---------- Datos de ejemplo ----------
const products = [
  // ===== TAMAÑOS =====
  { id: 'vvvik-coco', category: 'Vikingos', title: 'Vikingo de Coco', price: 4500, desc: 'Delicioso vikingo de coco 100% natural a base de leche.', image: 'images/vik-coco.png' },
  { id: 'vvvik-maracumango', category: 'Vikingos', title: 'Vikingo Maracumango', price: 4500, desc: 'Exótica mezcla de maracuyá y mango a base de leche.', image: 'images/vik-maracumango.png' },
  { id: 'vvvik-arequipe', category: 'Vikingos', title: 'Vikingo de Arequipe', price: 4500, desc: 'Delicioso vikingo con trozos de arequipe a base de leche.', image: 'images/vik-arequipe.png' },
  { id: 'vvvik-choconutella', category: 'Vikingos', title: 'Vikingo Choconutella', price: 4500, desc: 'Cremoso vikingo de chocolate y Nutella con trozos de crema de avellana a base de leche.', image: 'images/vik-choconutella.png' },
  { id: 'vvvik-curuba', category: 'Vikingos', title: 'Vikingo de Curuba', price: 4500, desc: 'Sabor tropical 100% natural a base de leche', image: 'images/vik-curuba.png' },
  { id: 'vvvik-guanabana', category: 'Vikingos', title: 'Vikingo de Guanábana', price: 4500, desc: 'Cremoso vikingo de guanábana 100% natural a base de leche.', image: 'images/vik-guanabana.png' },
  { id: 'vvvik-mangobiche', category: 'Vikingos', title: 'Vikingo de Mango Biche', price: 4500, desc: 'Refrescante combinación de Mango Biche 100% natural a base de agua', image: 'images/vik-mangobiche.png' },
  { id: 'vvvik-mora', category: 'Vikingos', title: 'Vikingo de Mora', price: 4500, desc: '100% fruta, sabor intenso y natural a base de leche', image: 'images/vik-mora.png' },
  { id: 'vvvik-ronpasas', category: 'Vikingos', title: 'Vikingo Ron con Pasas', price: 4500, desc: 'Sabor tradicional, cremoso a base de leche.', image: 'images/vik-ronpasas.png' },
  { id: 'vvvik-mantecado', category: 'Vikingos', title: 'Vikingo de Mantecado', price: 4500, desc: 'Sabor tradicional, suave y cremoso a base de leche.', image: 'images/vik-mantecado.png' },
  { id: 'vvvik-fresasfrutos', category: 'Vikingos', title: 'Vikingo Fresas con Frutos Rojos', price: 4500, desc: 'Combinación de fresas y mermelada de frutos rojos 100% natural a base de leche.', image: 'images/vik-fresasfrutos.png' },
  { id: 'vvvik-arrozconleche', category: 'Vikingos', title: 'Vikingo de Arroz con Leche', price: 4500, desc: 'Granos de arroz suaves en cada bocado, mezclados con una base láctea muy cremosa con unas cuantas uvas pasas.', image: 'images/vik-arrozconleche.png' },
  { id: 'vvvik-quesobocadillo', category: 'Vikingos', title: 'Vikingo Queso con Bocadillo', price: 4500, desc: 'Deliciosa combinación entre lo salado del queso y lo dulce del bocadillo 100% natural a base de leche', image: 'images/vik-quesobocadillo.png' },
  { id: 'vvvik-cafe', category: 'Vikingos', title: 'Vikingo de Café', price: 4500, desc: 'Delicioso vikingo cubierto con arequipe de café cremoso y refrescante a base de leche.', image: 'images/vik-cafe.png' },
  { id: 'vvvik-oreo', category: 'Vikingos', title: 'Vikingo de Oreo', price: 4500, desc: 'Cremoso vikingo con trozos de galleta Oreo 100% natural a base de leche.', image: 'images/vik-oreo.png' },
  { id: 'vvvik-tamarindo', category: 'Vikingos', title: 'Vikingo de tamarindo', price: 4500, desc: 'Delicioso vikingo hecho con pulpa natural. Recubierto con mermelada de tamarindo. A base de agua', image: 'images/vik-tamarindo.png' },
  { id: 'vvvik-pina', category: 'Vikingos', title: 'Vikingo de Piña', price: 4500, desc: 'Refrescante sabor tropical de piña natural a base de leche.', image: 'images/vik-pina.png' },
  { id: 'vvvik-galleta', category: 'Vikingos', title: 'Vikingo de Galleta', price: 4500, desc: 'Refrescante y delicioso con trocitos de galleta tipo rondalla a base de leche', image: 'images/vik-galleta.png' },
  { id: 'vvvik-banano', category: 'Vikingos', title: 'Vikingo de Banano', price: 4500, desc: 'Cremoso y delicioso a base de leche con trozo de banano', image: 'images/vik-banano.png' },
  { id: 'vvvik-sandia', category: 'Vikingos', title: 'Vikingo de Sandia', price: 4500, desc: 'Refrescante vikingo a base de agua con fruta natural', image: 'images/vik-sandia.png' },
  { id: 'vvvik-kola', category: 'Vikingos', title: 'Vikingo Kola con Leche', price: 4500, desc: 'Clásico sabor colombiano a base de leche.', image: 'images/vik-kola.png' },
  { id: 'vvvik-milo', category: 'Vikingos', title: 'Vikingo de Milo', price: 4500, desc: 'Cremoso vikingo con trocitos de milo crocante 100% natural a base de leche', image: 'images/vik-milo.png' },
  { id: 'vvvik-vainillachips', category: 'Vikingos', title: 'Vikingo Vainilla Chips', price: 4500, desc: 'Delicado sabor a vainilla con chispas de chocolate 100% natural a base de leche.', image: 'images/vik-vainillachips.png' },
  { id: 'vvvik-mani', category: 'Vikingos', title: 'Vikingo de Maní', price: 4500, desc: 'Vikingo cremoso con trocitos de maní 100% natural a base de leche.', image: 'images/vik-mani.png' },
  { id: 'vvvik-chicle', category: 'Vikingos', title: 'Vikingo de Chicle', price: 4500, desc: 'Delicioso suave y refrescante sabor a chicle con chicle añadido a base de leche', image: 'images/vik-chicle.png' },
  { id: 'vvvik-lulo', category: 'Vikingos', title: 'Vikingo de Lulo', price: 4500, desc: 'Delicioso vikingo con trocitos de lulo 100% Natural a base de leche.', image: 'images/vik-lulo.png' },
  { id: 'vvvik-salpicon', category: 'Vikingos', title: 'Vikingo de Salpicón', price: 4500, desc: 'Mix de frutas tropicales finamente picadas  100% natural a base de leche.', image: 'images/vik-salpicon.png' },
  { id: 'vvvik-nucita', category: 'Vikingos', title: 'Vikingo de Nucita', price: 4500, desc: 'Cremoso e irresistible vikingo combinado con chocolate blanco y chocolate negro 100% natural a base de leche.', image: 'images/vik-nucita.png' },
  //AGUAS
  { id: 'AAAgua1', category: 'Aguas', title: 'Botella agua cristal 600ml', price: 2500, desc: 'Botella de agua pura y refrescante 600ml.', image: 'images/aguaBotella1.png' },
  { id: 'AAAgua2', category: 'Aguas', title: 'Pequeña botella agua cristal 300 ml', price: 1500, desc: 'Botella de agua pura y refrescante 300ml.', image: 'images/aguaBotella2.png' },
...
checkoutForm.addEventListener('submit', (e) => {
  ...
  // Cabecera
  textParts.push('🧾 *Nuevo Pedido - Vikingos Indira Cañaveral BGA✅*');
